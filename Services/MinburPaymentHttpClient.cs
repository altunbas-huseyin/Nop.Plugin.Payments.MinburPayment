...
namespace Nop.Plugin.Payments.MinburPayment.Services
{
    /// <summary>
    /// Represents the HTTP client to request PayPal services
    /// </summary>
    public partial class MinburPaymentHttpClient
    {
        #region Fields
        ...
        public MinburPaymentHttpClient(HttpClient client,
        ...
        {
            //get response
            var url = _MinburPaymentPaymentSettings.UseSandbox ?
                "https://www.sandbox.paypal.com/us/cgi-bin/webscr" :
                "https://www.paypal.com/us/cgi-bin/webscr";
            var requestContent = new StringContent($"cmd=_notify-synch&at={_MinburPaymentPaymentSettings.PdtToken}&tx={tx}",
