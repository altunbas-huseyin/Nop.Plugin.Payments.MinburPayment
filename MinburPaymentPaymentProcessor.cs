...
using Nop.Plugin.Payments.MinburPayment.Services;
...
{
    /// <summary>
    /// MinburPayment payment processor
    /// </summary>
    public class MinburPaymentPaymentProcessor : BasePlugin, IPaymentMethod
    {
        #region Fields
        ...
        private readonly MinburPaymentHttpClient _MinburPaymentHttpClient;
        private readonly MinburPaymentPaymentSettings _MinburPaymentPaymentSettings;

        #endregion

        #region Ctor

        public MinburPaymentPaymentProcessor(CurrencySettings currencySettings,
            ...
            MinburPaymentHttpClient MinburPaymentHttpClient,
            MinburPaymentPaymentSettings MinburPaymentPaymentSettings)
        {
            ...
            _MinburPaymentHttpClient = MinburPaymentHttpClient;
            _MinburPaymentPaymentSettings = MinburPaymentPaymentSettings;
        }
        ...
        {
            response = WebUtility.UrlDecode(_MinburPaymentHttpClient.GetPdtDetailsAsync(tx).Result);
        ...
        {
            var response = WebUtility.UrlDecode(_MinburPaymentHttpClient.VerifyIpnAsync(formString).Result);
        ...
        private IDictionary<string, string> CreateQueryParameters(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                ["business"] = _MinburPaymentPaymentSettings.BusinessEmail,
                ...
                ["bn"] = MinburHelper.NopCommercePartnerCode,
                ...
                ["return"] = $"{storeLocation}Plugins/PaymentMinburPayment/PDTHandler",
                ["notify_url"] = $"{storeLocation}Plugins/PaymentMinburPayment/IPNHandler",
                ["cancel_return"] = $"{storeLocation}Plugins/PaymentMinburPayment/CancelOrder",
        ...
        private void AddItemsParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, MinburHelper.OrderTotalSentToPayPal, roundedCartTotal);
        }
        ...
        private void AddOrderTotalParameters(IDictionary<string, string> parameters, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            //save order total that actually sent to PayPal (used for PDT order total validation)
            _genericAttributeService.SaveAttribute(postProcessPaymentRequest.Order, MinburHelper.OrderTotalSentToPayPal, roundedOrderTotal);
        }
        ...
        public decimal GetAdditionalHandlingFee(IList<ShoppingCartItem> cart)
        {
            return _paymentService.CalculateAdditionalFee(cart,
                _MinburPaymentPaymentSettings.AdditionalFee, _MinburPaymentPaymentSettings.AdditionalFeePercentage);
        }
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentMinburPayment/Configure";
        }
        ...
        {
            //settings
            _settingService.SaveSetting(new MinburPaymentPaymentSettings
            {
                UseSandbox = true
            });
            ...
            {
                ["Plugins.Payments.MinburPayment.Fields.AdditionalFee"] = "Additional fee",
                ["Plugins.Payments.MinburPayment.Fields.AdditionalFee.Hint"] = "Enter additional fee to charge your customers.",
                ["Plugins.Payments.MinburPayment.Fields.AdditionalFeePercentage"] = "Additional fee. Use percentage",
                ["Plugins.Payments.MinburPayment.Fields.AdditionalFeePercentage.Hint"] = "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.",
                ["Plugins.Payments.MinburPayment.Fields.BusinessEmail"] = "Business Email",
                ["Plugins.Payments.MinburPayment.Fields.BusinessEmail.Hint"] = "Specify your PayPal business email.",
                ["Plugins.Payments.MinburPayment.Fields.PassProductNamesAndTotals"] = "Pass product names and order totals to PayPal",
                ["Plugins.Payments.MinburPayment.Fields.PassProductNamesAndTotals.Hint"] = "Check if product names and order totals should be passed to PayPal.",
                ["Plugins.Payments.MinburPayment.Fields.PDTToken"] = "PDT Identity Token",
                ["Plugins.Payments.MinburPayment.Fields.PDTToken.Hint"] = "Specify PDT identity token",
                ["Plugins.Payments.MinburPayment.Fields.RedirectionTip"] = "You will be redirected to PayPal site to complete the order.",
                ["Plugins.Payments.MinburPayment.Fields.UseSandbox"] = "Use Sandbox",
                ["Plugins.Payments.MinburPayment.Fields.UseSandbox.Hint"] = "Check to enable Sandbox (testing environment).",
                ["Plugins.Payments.MinburPayment.Instructions"] = @"
                    <p>
	                    ...
	                    <br />1. Log in to your PayPal account (click <a href=""https://www.minbur.com/us/webapps/mpp/referral/paypal-business-account2?partner_id=9JJPJNNPQ7PZ8"" target=""_blank"">here</a> to create your account).
                ...
                ["Plugins.Payments.MinburPayment.PaymentMethodDescription"] = "You will be redirected to PayPal site to complete the payment",
                ["Plugins.Payments.MinburPayment.RoundingWarning"] = "It looks like you have \"ShoppingCartSettings.RoundPricesDuringCalculation\" setting disabled. Keep in mind that this can lead to a discrepancy of the order total amount, as PayPal only rounds to two decimals.",
        ...
        {
            //settings
            _settingService.DeleteSetting<MinburPaymentPaymentSettings>();

            //locales
            _localizationService.DeletePluginLocaleResources("Plugins.Payments.MinburPayment");
        ...
        /// </summary>
        public string PaymentMethodDescription => _localizationService.GetResource("Plugins.Payments.MinburPayment.PaymentMethodDescription");
